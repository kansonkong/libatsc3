/*
 * atsc3_utils_sha256.c
 *
 *  Created on: Jul 27, 2020
 *      Author: jjustman
 *
 *      from: https://raw.githubusercontent.com/B-Con/crypto-algorithms/master/sha256.c
 */
...
void sha256_transform(atsc3_SHA256_CTX *ctx, const BYTE data[])
{
