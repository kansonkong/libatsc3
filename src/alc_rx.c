		...
		while(exthdrlen > 0) {
			...
			switch(het) {
			  ...
			  case EXT_FTI:
				  ...
				  ALC_RX_TRACE("EXT_FTI: %i, def_lct_hdr->hdr_len: %d, exthdrlen: %d, hdrlen:%d, het: %d, hel: %d", hel, def_lct_hdr->hdr_len, exthdrlen, hdrlen, het, hel);
				  ...
				  ALC_RX_TRACE("def_lct_hdr->hdr_len: %d, exthdrlen: %d, hdrlen:%d, het: %d, hel: %d", def_lct_hdr->hdr_len, exthdrlen, hdrlen, het, hel);
