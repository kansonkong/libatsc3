...
typedef struct atsc3_route_dash_metadata atsc3_route_dash_metadata_t;
...
typedef void (*atsc3_alc_on_route_mpd_metadata_adaptation_set_cenc_pssh_f)(uint16_t service_id, atsc3_route_dash_metadata_t* atsc3_route_dash_metadata);
