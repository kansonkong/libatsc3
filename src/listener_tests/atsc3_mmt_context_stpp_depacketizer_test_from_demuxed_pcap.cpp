/*
 * atsc3_mmt_context_stpp_depacketizer_test_from_demuxed_pcap.c
 *
...
#define _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_ERROR(...)    __LIBATSC3_TIMESTAMP_ERROR(__VA_ARGS__);
#define _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_WARN(...)     __LIBATSC3_TIMESTAMP_WARN(__VA_ARGS__);
#define _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_INFO(...)     __LIBATSC3_TIMESTAMP_INFO(__VA_ARGS__);
#define _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG(...)    __LIBATSC3_TIMESTAMP_DEBUG(__VA_ARGS__);
#define _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_TRACE(...) // __LIBATSC3_TIMESTAMP_TRACE(__VA_ARGS__);
...
void atsc3_mmt_signalling_information_on_stpp_essence_packet_id_dump(atsc3_mmt_mfu_context_t* atsc3_mmt_mfu_context, uint16_t stpp_packet_id, mp_table_asset_row_t* mp_table_asset_row) {
	_ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("atsc3_mmt_signalling_information_on_stpp_essence_packet_id_dump: stpp mp_table packet_id: %u, stpp_packet_id_under_test: %u",
			stpp_packet_id,
...
void atsc3_mmt_signalling_information_on_stpp_packet_id_with_mpu_timestamp_descriptor_dump(atsc3_mmt_mfu_context_t* atsc3_mmt_mfu_context, uint16_t stpp_packet_id, uint32_t mpu_sequence_number, uint64_t mpu_presentation_time_ntp64, uint32_t mpu_presentation_time_seconds, uint32_t mpu_presentation_time_microseconds) {
	_ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("atsc3_mmt_signalling_information_on_stpp_packet_id_with_mpu_timestamp_descriptor_dump: stpp mp_table packet_id: %u, stpp_packet_id_under_test: %u, mpu_sequence_number: %d, mpu_presentation_time_ntp64: %"PRIu64", mpu_presentation_time_seconds: %u, mpu_presentation_time_microseconds: %u",
				stpp_packet_id,
				atsc3_mmt_context_stpp_packet_id_for_testing,
				mpu_sequence_number,
...
void atsc3_mmt_mpu_mfu_on_sample_complete_dump(atsc3_mmt_mfu_context_t* atsc3_mmt_mfu_context, uint16_t packet_id, uint32_t mmtp_timestamp, uint32_t mpu_sequence_number, uint32_t sample_number, block_t* mmt_mfu_sample, uint32_t mfu_fragment_count_rebuilt) {
	...
	_ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("atsc3_mmt_mpu_mfu_on_sample_complete_dump: packet_id: %u, mpu_sequence_number: %u, mmtp_timestamp: %u, sample_number: %u, mmt_mfu_sample: %p, len: %d",
			packet_id,
            mpu_sequence_number,
			mmtp_timestamp,
            sample_number,
    ...
    if(fp) {
    	...
    	fclose(fp);
    	  ...
    	  _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("ERROR writing sample to complete filename: %s, atsc3_mmt_mpu_mfu_on_sample_complete_dump: packet_id: %u, mpu_sequence_number: %u, sample_number: %u, mmt_mfu_sample: %p, len: %d",
    			    myFileName,
				  	packet_id,
    	            mpu_sequence_number,
    	            sample_number,
...
void atsc3_mmt_mpu_mfu_on_sample_corrupt_dump(atsc3_mmt_mfu_context_t* atsc3_mmt_mfu_context, uint16_t packet_id, uint32_t mmtp_timestamp, uint32_t mpu_sequence_number, uint32_t sample_number, block_t* mmt_mfu_sample, uint32_t mfu_fragment_count_expected, uint32_t mfu_fragment_count_rebuilt) {
	...
	_ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("atsc3_mmt_mpu_mfu_on_sample_corrupt_dump: packet_id: %u, mpu_sequence_number: %u, mmtp_timestamp: %u, sample_number: %u, mmt_mfu_sample: %p, len: %d",
				packet_id,
	            mpu_sequence_number,
				mmtp_timestamp,
	            sample_number,
	...
	if(fp) {
		...
		fclose(fp);
		  ...
		  _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("ERROR writing sample to corrupt filename: %s, atsc3_mmt_mpu_mfu_on_sample_complete_dump: packet_id: %u, mpu_sequence_number: %u, sample_number: %u, mmt_mfu_sample: %p, len: %d",
					myFileName,
					packet_id,
					mpu_sequence_number,
					sample_number,
...
void atsc3_mmt_mpu_mfu_on_sample_missing_dump(atsc3_mmt_mfu_context_t* atsc3_mmt_mfu_context, uint16_t packet_id, uint32_t mpu_sequence_number, uint32_t sample_number) {
	...
	_ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("atsc3_mmt_mpu_mfu_on_sample_complete_dump: packet_id: %u, mpu_sequence_number: %u, sample_number: %u",
				packet_id,
	            mpu_sequence_number,
	            sample_number);
	...
	if(fp) {
		...
		fclose(fp);
		  ...
		  _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("ERROR writing sample to missing filename: %s, atsc3_mmt_mpu_mfu_on_sample_complete_dump: packet_id: %u, mpu_sequence_number: %u, sample_number: %u",
					myFileName,
					packet_id,
					mpu_sequence_number,
					sample_number);
...
int main(int argc,char **argv) {
   ...
   if(argc>=4) {
       ...
       _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("reading file %s, dst_ip: %s (%p), dst_port: %s (%p)",
                                                                PCAP_FILENAME,
                                                                filter_dst_ip,
                                                                dst_ip_addr_filter,
                                                                filter_dst_port,
   ...
   atsc3_pcap_replay_context = atsc3_pcap_replay_open_filename(PCAP_FILENAME);
    _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("Opening pcap: %s, context is: %p", PCAP_FILENAME, atsc3_pcap_replay_context);
   ...
   if(atsc3_pcap_replay_context) {
       while((atsc3_pcap_replay_context = atsc3_pcap_replay_iterate_packet(atsc3_pcap_replay_context))) {
           ...
           _ATSC3_MMT_CONTEXT_STPP_FROM_DEMUXED_PCAP_TEST_DEBUG("pcap reader release: pos: %ld, Got packet len: %d, ts_sec: %u, ts_usec: %u",
