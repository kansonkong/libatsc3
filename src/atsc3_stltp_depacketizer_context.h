...
#define _ATSC3_STLTP_DEPACKETIZER_CONTEXT_INFO(...)    __LIBATSC3_TIMESTAMP_INFO(__VA_ARGS__);
#define _ATSC3_STLTP_DEPACKETIZER_CONTEXT_DEBUG(...)    __LIBATSC3_TIMESTAMP_DEBUG(__VA_ARGS__);
