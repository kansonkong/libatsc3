...
/*
 ...
 cms header from A/360 for SLS validation, sample from enensys - 2020-11-17:
...
cms signature from A/360 for SLS validation, sample from enensys - 2020-11-17:
...
typedef struct atsc3_cms_validation_context {
...
#define _ATSC3_CMS_UTILS_ERROR(...)  __LIBATSC3_TIMESTAMP_ERROR(__VA_ARGS__);
#define _ATSC3_CMS_UTILS_WARN(...)   __LIBATSC3_TIMESTAMP_WARN(__VA_ARGS__);
#define _ATSC3_CMS_UTILS_INFO(...)   if(_ATSC3_CMS_UTILS_INFO_ENABLED)  { __LIBATSC3_TIMESTAMP_INFO(__VA_ARGS__);  }
#define _ATSC3_CMS_UTILS_DEBUG(...)  if(_ATSC3_CMS_UTILS_DEBUG_ENABLED) { __LIBATSC3_TIMESTAMP_DEBUG(__VA_ARGS__); }
#define _ATSC3_CMS_UTILS_TRACE(...)  if(_ATSC3_CMS_UTILS_TRACE_ENABLED) { __LIBATSC3_TIMESTAMP_TRACE(__VA_ARGS__); }

#endif /* ATSC3_CMS_UTILS_H_ */
