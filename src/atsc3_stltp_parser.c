...
//
//    atsc3_ip_udp_rtp_packet_t* ip_udp_rtp_packet_new = atsc3_ip_udp_rtp_packet_prepend_if_not_null(atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_inner_last_fragment, atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_outer);
...
block_t* atsc3_stltp_read_from_outer_packet(atsc3_ip_udp_rtp_packet_t* ip_udp_rtp_packet_outer, bool after_refragment) {
    ...
    inner_packet_data =  ip_udp_rtp_packet_outer->data; //return a reference to our
...
atsc3_ip_udp_rtp_packet_t* atsc3_stltp_tunnel_packet_inner_parse_ip_udp_header_outer_data(atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet) {
    ...
    ip_udp_rtp_packet_inner_new->data = atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_outer->data;
...
atsc3_stltp_tunnel_packet_t* atsc3_stltp_raw_packet_extract_inner_from_outer_packet(atsc3_ip_udp_rtp_packet_t* ip_udp_rtp_packet, atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet_last) {
    ...
    atsc3_stltp_tunnel_packet_clear_completed_inner_packets(atsc3_stltp_tunnel_packet_last);
    ...
    if(atsc3_stltp_tunnel_packet_last && atsc3_stltp_tunnel_packet_last->ip_udp_rtp_packet_outer) {
        ...
        if(last_outer_packet_bytes_remaining_to_parse > 0) {
            ...
            block_t* inner_payload_current = atsc3_stltp_read_from_outer_packet(atsc3_stltp_tunnel_packet_last->ip_udp_rtp_packet_outer, false);
    ...
    if(atsc3_stltp_tunnel_packet_last && atsc3_stltp_tunnel_packet_last->ip_udp_rtp_packet_inner) {
        ...
        atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_inner->data = atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_outer->data;
    ...
    while(block_Remaining_size(atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_outer->data) > ATSC_STLTP_IP_UDP_RTP_HEADER_SIZE) {
...
atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet_extract_fragment_encapsulated_payload(atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet_current)  {

//    atsc3_rtp_header_t* rtp_header_inner = atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_inner->rtp_header;
//
//    //move past our ip/udp/rtp header for inner packet extraction
//    //TODO - determine what to do with outer data pos with variable length reads..
//    block_Seek_Relative(atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_inner->data, ATSC_STLTP_IP_UDP_RTP_HEADER_SIZE);
//
...
atsc3_stltp_baseband_packet_t* atsc3_stltp_baseband_packet_extract(atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet_current) {
	...
	if(!atsc3_stltp_baseband_packet_pending) {
        ...
        atsc3_stltp_baseband_packet_pending->rtp_header = atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_inner->rtp_header;
        atsc3_stltp_baseband_packet_pending->payload_length = atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_inner->rtp_header->packet_offset;
        
        atsc3_stltp_tunnel_packet_current->atsc3_stltp_baseband_packet_pending = atsc3_stltp_baseband_packet_pending;
	}

    block_t* packet = atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_inner->data;
...
atsc3_stltp_preamble_packet_t* atsc3_stltp_preamble_packet_extract(atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet_current) {
    ...
    atsc3_stltp_preamble_packet_pending->rtp_header = atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_inner->rtp_header;
    block_t* packet = atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_inner->data;
...
atsc3_stltp_timing_management_packet_t* atsc3_stltp_timing_management_packet_extract(atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet_current) {
    ...
    atsc3_stltp_timing_management_packet_pending->rtp_header = atsc3_stltp_tunnel_packet_current->ip_udp_rtp_packet_inner->rtp_header;
...
void atsc3_stltp_tunnel_packet_free(atsc3_stltp_tunnel_packet_t** atsc3_stltp_tunnel_packet_p) {
    if(atsc3_stltp_tunnel_packet_p) {
        ...
        if(atsc3_stltp_tunnel_packet) {
            if(atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_inner && atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_outer &&
               atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_inner->data == atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_outer->data) {
                atsc3_ip_udp_rtp_packet_free(&atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_inner);
                atsc3_ip_udp_rtp_packet_and_data_free(&atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_outer);
            } else {
                atsc3_ip_udp_rtp_packet_and_data_free(&atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_inner);
                atsc3_ip_udp_rtp_packet_and_data_free(&atsc3_stltp_tunnel_packet->ip_udp_rtp_packet_outer);
            }
