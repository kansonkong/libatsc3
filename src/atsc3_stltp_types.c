...
bool atsc3_stltp_tunnel_packet_is_rtp_packet_outer_sequence_number_contiguous(atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet_last, atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet_current) {
	...
	if(atsc3_stltp_tunnel_packet_last && atsc3_stltp_tunnel_packet_last->ip_udp_rtp_ctp_packet_outer && atsc3_stltp_tunnel_packet_last->ip_udp_rtp_ctp_packet_outer->rtp_ctp_header &&
	   atsc3_stltp_tunnel_packet_current && atsc3_stltp_tunnel_packet_current->ip_udp_rtp_ctp_packet_outer && atsc3_stltp_tunnel_packet_current->ip_udp_rtp_ctp_packet_outer->rtp_ctp_header) {
		uint16_t last_sequence_number = atsc3_stltp_tunnel_packet_last->ip_udp_rtp_ctp_packet_outer->rtp_ctp_header->sequence_number;
		uint16_t current_sequence_number = atsc3_stltp_tunnel_packet_current->ip_udp_rtp_ctp_packet_outer->rtp_ctp_header->sequence_number;
...
atsc3_stltp_baseband_packet_t* atsc3_stltp_baseband_packet_new_and_init(atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet) {
    ...
    //ref ip_udp_rtp_ctp_packet_outer w/ rtp_header_outer
    atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_outer = atsc3_ip_udp_rtp_ctp_packet_duplicate(atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer);

    //ref ip_udp_rtp_ctp_packet_inner w/ rtp_header_inner
    atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner = atsc3_ip_udp_rtp_ctp_packet_duplicate(atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner);

    if(atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->udp_flow.dst_port >= 30000 && atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->udp_flow.dst_port < 30064) {
    	atsc3_stltp_baseband_packet->plp_num = atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->udp_flow.dst_port - 30000;
	} else {
		atsc3_stltp_baseband_packet->plp_num = 255; //unknown
	}
    
    //TODO: inner packet size, only if we are from a marker
    atsc3_stltp_baseband_packet->payload_length = atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header->packet_offset;
...
void atsc3_baseband_packet_set_plp_from_stltp_baseband_packet(atsc3_baseband_packet_t* atsc3_baseband_packet, atsc3_stltp_baseband_packet_t* atsc3_stltp_baseband_packet) {
	...
	if(atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->udp_flow.dst_port >= 30000 && atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->udp_flow.dst_port < 30064) {
		atsc3_baseband_packet->plp_num = atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->udp_flow.dst_port - 30000;
	} else {
...
void atsc3_baseband_packet_set_bootstrap_timing_ref_from_stltp_baseband_packet(atsc3_baseband_packet_t* atsc3_baseband_packet, atsc3_stltp_baseband_packet_t* atsc3_stltp_baseband_packet) {
	if(!atsc3_baseband_packet || !atsc3_stltp_baseband_packet || !atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner || !atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header) {
	...
	atsc3_baseband_packet->bootstrap_timing_data_timestamp_short_reference.seconds_pre = 0x3FFFFF & (atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header->timestamp >> 10);

	//last 10 bits from timestamp field
	atsc3_baseband_packet->bootstrap_timing_data_timestamp_short_reference.a_milliseconds_pre = 0x3FF & atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header->timestamp;
}
...
void atsc3_preamble_packet_set_bootstrap_timing_ref_from_stltp_preamble_packet(atsc3_preamble_packet_t* atsc3_preamble_packet, atsc3_stltp_preamble_packet_t* atsc3_stltp_preamble_packet) {
	if(!atsc3_preamble_packet || !atsc3_stltp_preamble_packet || !atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_inner || !atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header) {
	...
	//first 22 bits from timestamp field
	atsc3_preamble_packet->bootstrap_timing_data_timestamp_short_reference.seconds_pre = 0x3FFFFF & (atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header->timestamp >> 10);

	//last 10 bits from timestamp field
	atsc3_preamble_packet->bootstrap_timing_data_timestamp_short_reference.a_milliseconds_pre = 0x3FF & atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header->timestamp;
}
...
void atsc3_timing_management_packet_set_bootstrap_timing_ref_from_stltp_preamble_packet(atsc3_timing_management_packet_t* atsc3_timing_management_packet, atsc3_stltp_timing_management_packet_t* atsc3_stltp_timing_management_packet) {
	if(!atsc3_timing_management_packet || !atsc3_stltp_timing_management_packet || !atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_inner || !atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header) {
	...
	//first 22 bits from timestamp field
	atsc3_timing_management_packet->bootstrap_timing_data_timestamp_short_reference.seconds_pre = 0x3FFFFF & (atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header->timestamp >> 10);

	//last 10 bits from timestamp field
	atsc3_timing_management_packet->bootstrap_timing_data_timestamp_short_reference.a_milliseconds_pre = 0x3FF & atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header->timestamp;
}
...
void atsc3_stltp_tunnel_packet_free(atsc3_stltp_tunnel_packet_t** atsc3_stltp_tunnel_packet_p) {
    if(atsc3_stltp_tunnel_packet_p) {
        ...
        if(atsc3_stltp_tunnel_packet) {
            ...
            if(atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer) {
                atsc3_ip_udp_rtp_ctp_packet_free(&atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer);
            }
            
            if(atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_pending_refragmentation_outer) {
                atsc3_ip_udp_rtp_ctp_packet_free(&atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_pending_refragmentation_outer);
            }
            
            if(atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_pending_concatenation_inner) {
                atsc3_ip_udp_rtp_ctp_packet_free(&atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_pending_concatenation_inner);
            }
...
void atsc3_stltp_tunnel_packet_destroy(atsc3_stltp_tunnel_packet_t** atsc3_stltp_tunnel_packet_p) {
    if(atsc3_stltp_tunnel_packet_p) {
        ...
        if(atsc3_stltp_tunnel_packet) {
            ...
            atsc3_ip_udp_rtp_ctp_packet_destroy_outer_inner(&atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer, &atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner);
...
void atsc3_stltp_tunnel_packet_outer_destroy(atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet) {
    if(atsc3_stltp_tunnel_packet) {
        ...
        if(atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer && atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner &&
           atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer->data == atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner->data) {
            block_Destroy(&atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer->data);
            atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner->data = NULL;
        }
        if(atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer) {
            atsc3_ip_udp_rtp_ctp_packet_destroy(&atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer);
            atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer = NULL;
        }
    }
}
    ...
    if(atsc3_stltp_tunnel_packet) {
        ...
        if(atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer && atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner &&
           atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer->data == atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner->data) {
            ...
            atsc3_rtp_ctp_header_free(&atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner->rtp_ctp_header);
        } else if(atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner) {
            atsc3_ip_udp_rtp_ctp_packet_destroy(&atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner);
            atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner = NULL;
        }
    }
}
...
void atsc3_stltp_baseband_packet_free_v(atsc3_stltp_baseband_packet_t* atsc3_stltp_baseband_packet) {
    if(atsc3_stltp_baseband_packet) {
        ...
        atsc3_ip_udp_rtp_ctp_packet_destroy_outer_inner(&atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_outer, &atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner);
...
/*
 free only the ip_udp_rtp_ctp_packet outer/inner data payloads, as we will have rebuilt what the baseband packet needs in its ->payload
...
void atsc3_stltp_baseband_packet_free_outer_inner_data(atsc3_stltp_baseband_packet_t* atsc3_stltp_baseband_packet) {
    ...
    if(atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_outer && atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_outer->data) {
        block_Destroy(&atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_outer->data);
    }
    
    if(atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner && atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->data) {
        block_Destroy(&atsc3_stltp_baseband_packet->ip_udp_rtp_ctp_packet_inner->data);
    }
}
...
void atsc3_stltp_preamble_packet_free_outer_inner_data(atsc3_stltp_preamble_packet_t* atsc3_stltp_preamble_packet) {
    ...
    if(atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_outer && atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_outer->data) {
        block_Destroy(&atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_outer->data);
    }
    
    if(atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_inner && atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_inner->data) {
        block_Destroy(&atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_inner->data);
    }
}
...
void atsc3_stltp_timing_management_packet_free_outer_inner_data(atsc3_stltp_timing_management_packet_t* atsc3_stltp_timing_management_packet) {
    ...
    if(atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_outer && atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_outer->data) {
        block_Destroy(&atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_outer->data);
    }
    
    if(atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_inner && atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_inner->data) {
        block_Destroy(&atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_inner->data);
    }
}
...
void atsc3_stltp_preamble_packet_free_v(atsc3_stltp_preamble_packet_t* atsc3_stltp_preamble_packet) {
    if(atsc3_stltp_preamble_packet) {
        ...
        atsc3_ip_udp_rtp_ctp_packet_free(&atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_outer);
        atsc3_ip_udp_rtp_ctp_packet_free(&atsc3_stltp_preamble_packet->ip_udp_rtp_ctp_packet_inner);
        //this should be all boilerplate
...
/**
 ...
 atsc3_rtp_ctp_header_t*             rtp_header_outer; //pointer from ip_udp_rtp_ctp_packet_outer->rtp_header
 
 atsc3_ip_udp_rtp_ctp_packet_t*      ip_udp_rtp_ctp_packet_inner;
 atsc3_rtp_ctp_header_t*             rtp_header_inner; //pointer from ip_udp_rtp_ctp_packet_outer->rtp_header
...
void atsc3_stltp_timing_management_packet_free_v(atsc3_stltp_timing_management_packet_t* atsc3_stltp_timing_management_packet) {
    if(atsc3_stltp_timing_management_packet) {
        ...
        atsc3_ip_udp_rtp_ctp_packet_free(&atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_outer);
        atsc3_ip_udp_rtp_ctp_packet_free(&atsc3_stltp_timing_management_packet->ip_udp_rtp_ctp_packet_inner);
        //this shoudl be all boilerplate
...
void atsc3_rtp_ctp_header_dump_outer(atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet) {
    atsc3_ip_udp_rtp_ctp_packet_t* atsc3_ip_udp_rtp_ctp_packet_outer = atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_outer;
    atsc3_rtp_ctp_header_t* atsc3_rtp_ctp_header = atsc3_ip_udp_rtp_ctp_packet_outer->rtp_ctp_header;
    udp_flow_t atsc3_udp_flow = atsc3_ip_udp_rtp_ctp_packet_outer->udp_flow;
    
    __STLTP_TYPES_DEBUG(" ---outer: payload_type: %s (%hhu), sequence_number: %d (p: %p), dst: %u.%u.%u.%u:%u, pos: %d, size: %d---",
                         ATSC3_CTP_STL_PAYLOAD_TYPE_TO_STRING(atsc3_rtp_ctp_header->payload_type),
                         atsc3_rtp_ctp_header->payload_type,
                         atsc3_rtp_ctp_header->sequence_number,
                         atsc3_ip_udp_rtp_ctp_packet_outer,
                         __toipandportnonstruct(atsc3_udp_flow.dst_ip_addr, atsc3_udp_flow.dst_port),
                        atsc3_ip_udp_rtp_ctp_packet_outer->data ? atsc3_ip_udp_rtp_ctp_packet_outer->data->i_pos : -1,
                        atsc3_ip_udp_rtp_ctp_packet_outer->data ? atsc3_ip_udp_rtp_ctp_packet_outer->data->p_size : -1);
    atsc3_rtp_ctp_header_dump(atsc3_rtp_ctp_header, 5);
    __STLTP_TYPES_DEBUG(" ---outer: end---");
}

void atsc3_rtp_ctp_header_dump_inner(atsc3_stltp_tunnel_packet_t* atsc3_stltp_tunnel_packet) {
    atsc3_ip_udp_rtp_ctp_packet_t* atsc3_ip_udp_rtp_ctp_packet_inner = atsc3_stltp_tunnel_packet->ip_udp_rtp_ctp_packet_inner;
    atsc3_rtp_ctp_header_t* atsc3_rtp_ctp_header = atsc3_ip_udp_rtp_ctp_packet_inner->rtp_ctp_header;
    udp_flow_t atsc3_udp_flow = atsc3_ip_udp_rtp_ctp_packet_inner->udp_flow;
    ...
    atsc3_rtp_ctp_header_dump(atsc3_rtp_ctp_header, 9);
...
void atsc3_rtp_ctp_header_dump(atsc3_rtp_ctp_header_t* atsc3_rtp_ctp_header, int spaces) {
    ...
    __STLTP_TYPES_DEBUG("%*smarker: %x,  version: %x, padding: %x, extension: %x, csrc_count: %x",
                        ...
                        atsc3_rtp_ctp_header->csrc_count);
    
    //tunnel packet has packet offset
    if(atsc3_rtp_ctp_header->payload_type == 0x61) {
        
        __STLTP_TYPES_DEBUG("%*ssequence_number: 0x%x (%u), timestamp: 0x%x (%u)  packet_offset: 0x%x (%u)", spaces, "",
                             atsc3_rtp_ctp_header->sequence_number, atsc3_rtp_ctp_header->sequence_number,
                             atsc3_rtp_ctp_header->timestamp, atsc3_rtp_ctp_header->timestamp,
                             atsc3_rtp_ctp_header->packet_offset, atsc3_rtp_ctp_header->packet_offset);
    } else {
    	//only ATSC3_RTP_CTP_PAYLOAD_TYPE_STLTP_INNER_BASEBAND_PACKET uses atsc3_rtp_ctp_header->packet_offset as length in the header

    	if(atsc3_rtp_ctp_header->payload_type == ATSC3_RTP_CTP_PAYLOAD_TYPE_STLTP_INNER_BASEBAND_PACKET) {
			__STLTP_TYPES_DEBUG("%*ssequence_number: 0x%x (%u), timestamp: 0x%x (%u)  packet length: 0x%x (%u)", spaces, "",
								 atsc3_rtp_ctp_header->sequence_number, atsc3_rtp_ctp_header->sequence_number,
								 atsc3_rtp_ctp_header->timestamp, atsc3_rtp_ctp_header->timestamp,
								 atsc3_rtp_ctp_header->packet_offset, atsc3_rtp_ctp_header->packet_offset);
    	} else {
			__STLTP_TYPES_DEBUG("%*ssequence_number: 0x%x (%u), timestamp: 0x%x (%u)  SSRC id: %u (should be 0)", spaces, "",
								 atsc3_rtp_ctp_header->sequence_number, atsc3_rtp_ctp_header->sequence_number,
								 atsc3_rtp_ctp_header->timestamp, atsc3_rtp_ctp_header->timestamp,
