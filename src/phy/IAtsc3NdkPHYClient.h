...
typedef void(*atsc3_rx_udp_packet_process_callback_f)(block_t* block);
...
class IAtsc3NdkPHYClient {
	...
	public:
		...
		virtual void SetRxUdpPacketProcessCallback(atsc3_rx_udp_packet_process_callback_f atsc3_rx_udp_packet_process_callback) {
			this->atsc3_rx_udp_packet_process_callback = atsc3_rx_udp_packet_process_callback;
		}
	...
	protected:
		atsc3_rx_udp_packet_process_callback_f atsc3_rx_udp_packet_process_callback;
};
