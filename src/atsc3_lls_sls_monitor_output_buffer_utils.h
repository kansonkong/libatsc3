...
int lls_sls_monitor_output_buffer_copy_and_recover_sample_fragment_block(lls_sls_monitor_buffer_isobmff_t* lls_sls_monitor_buffer_isobmff, mpu_sequence_number_mmtp_mpu_packet_t* mpu_sequence_number_mmtp_mpu_packet);
