...
int _MMT_SI_TYPES_DEBUG_ENABLED = 0;
int _MMT_SI_TYPES_TRACE_ENABLED = 0;
...
ATSC3_VECTOR_BUILDER_METHODS_ITEM_FREE(mmt_atsc3_message_content_type_video_stream_properties_descriptor_asset);
	...
	if(mmt_signalling_message_header_and_payload) {
		...
		if(mmt_signalling_message_header_and_payload->message_header.MESSAGE_id_type >= MMT_ATSC3_MESSAGE_ID) {
			...
			if(mmt_signalling_message_header_and_payload->message_payload.mmt_atsc3_message_payload.mmt_atsc3_message_content_type_video_stream_properties_descriptor) {
				mmt_atsc3_message_content_type_video_stream_properties_descriptor_free(&mmt_signalling_message_header_and_payload->message_payload.mmt_atsc3_message_payload.mmt_atsc3_message_content_type_video_stream_properties_descriptor);
			}
			...
			if(mmt_signalling_message_header_and_payload->message_payload.mmt_atsc3_message_payload.mmt_atsc3_message_content_type_audio_stream_properties_descriptor) {
				mmt_atsc3_message_content_type_audio_stream_properties_descriptor_free(&mmt_signalling_message_header_and_payload->message_payload.mmt_atsc3_message_payload.mmt_atsc3_message_content_type_audio_stream_properties_descriptor);
...
void mmt_atsc3_message_content_type_video_stream_properties_descriptor_free(mmt_atsc3_message_content_type_video_stream_properties_descriptor_t** mmt_atsc3_message_content_type_video_stream_properties_descriptor_p) {
	if(mmt_atsc3_message_content_type_video_stream_properties_descriptor_p) {
		mmt_atsc3_message_content_type_video_stream_properties_descriptor_t* mmt_atsc3_message_content_type_video_stream_properties_descriptor = *mmt_atsc3_message_content_type_video_stream_properties_descriptor_p;

		if(mmt_atsc3_message_content_type_video_stream_properties_descriptor) {
			//iterate thru mmt_atsc3_message_content_type_video_stream_properties_descriptor_asset
			for(int i=0; i < mmt_atsc3_message_content_type_video_stream_properties_descriptor->mmt_atsc3_message_content_type_video_stream_properties_descriptor_asset_v.count; i++) {
				...
				if(mmt_atsc3_message_content_type_video_stream_properties_descriptor_asset) {
				...
				mmt_atsc3_message_content_type_video_stream_properties_descriptor->mmt_atsc3_message_content_type_video_stream_properties_descriptor_asset_v.data[i] = NULL;
			}

			freesafe(mmt_atsc3_message_content_type_video_stream_properties_descriptor->mmt_atsc3_message_content_type_video_stream_properties_descriptor_asset_v.data);
			mmt_atsc3_message_content_type_video_stream_properties_descriptor->mmt_atsc3_message_content_type_video_stream_properties_descriptor_asset_v.count = 0;
			mmt_atsc3_message_content_type_video_stream_properties_descriptor->mmt_atsc3_message_content_type_video_stream_properties_descriptor_asset_v.size = 0;

			freesafe(mmt_atsc3_message_content_type_video_stream_properties_descriptor);
			mmt_atsc3_message_content_type_video_stream_properties_descriptor = NULL;
		}

		mmt_atsc3_message_content_type_video_stream_properties_descriptor_p = NULL;
	}
}
...
void mmt_atsc3_message_content_type_audio_stream_properties_descriptor_free(mmt_atsc3_message_content_type_audio_stream_properties_descriptor_t** mmt_atsc3_message_content_type_audio_stream_properties_descriptor_p) {
	if(mmt_atsc3_message_content_type_audio_stream_properties_descriptor_p) {
		mmt_atsc3_message_content_type_audio_stream_properties_descriptor_t* mmt_atsc3_message_content_type_audio_stream_properties_descriptor = *mmt_atsc3_message_content_type_audio_stream_properties_descriptor_p;

		if(mmt_atsc3_message_content_type_audio_stream_properties_descriptor) {
			//iterate thru mmt_atsc3_message_content_type_video_stream_properties_descriptor_asset
			for(int i=0; i < mmt_atsc3_message_content_type_audio_stream_properties_descriptor->mmt_atsc3_message_content_type_audio_stream_properties_descriptor_asset_v.count; i++) {
				...
				for(int j=0; j < mmt_atsc3_message_content_type_audio_stream_properties_descriptor_asset->mmt_atsc3_message_content_type_audio_stream_properties_descriptor_asset_presentation_v.count; j++) {
			...
			freesafe(mmt_atsc3_message_content_type_audio_stream_properties_descriptor);
			mmt_atsc3_message_content_type_audio_stream_properties_descriptor = NULL;
		}

		mmt_atsc3_message_content_type_audio_stream_properties_descriptor_p = NULL;
	}
}
...
void mmt_atsc3_message_content_type_caption_asset_descriptor_free(mmt_atsc3_message_content_type_caption_asset_descriptor_t** mmt_atsc3_message_content_type_caption_asset_descriptor_p) {
	...
	if(mmt_atsc3_message_content_type_caption_asset_descriptor_p) {
		mmt_atsc3_message_content_type_caption_asset_descriptor_t* mmt_atsc3_message_content_type_caption_asset_descriptor = *mmt_atsc3_message_content_type_caption_asset_descriptor_p;

		if(mmt_atsc3_message_content_type_caption_asset_descriptor) {
			//iterate thru mmt_atsc3_message_content_type_video_stream_properties_descriptor_asset
			for (int i = 0; i < mmt_atsc3_message_content_type_caption_asset_descriptor->mmt_atsc3_message_content_type_caption_asset_descriptor_asset_v.count; i++) {
