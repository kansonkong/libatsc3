...
extern int _ATSC3_ISOBMFF_BOX_PARSER_TOOLS_INFO_ENABLED;
extern int _ATSC3_ISOBMFF_BOX_PARSER_TOOLS_DEBUG_ENABLED;
extern int _ATSC3_ISOBMFF_BOX_PARSER_TOOLS_TRACE_ENABLED;

extern int _ATSC3_AUDIO_DECODER_CONFIGURATION_RECORD_INFO_ENABLED;
extern int _ATSC3_AUDIO_DECODER_CONFIGURATION_RECORD_DEBUG_ENABLED;
extern int _ATSC3_AUDIO_DECODER_CONFIGURATION_RECORD_TRACE_ENABLED;

extern int _ATSC3_MMT_MFU_CONTEXT_CALLBACKS_DEFAULT_JNI_INFO_ENABLED;
extern int _ATSC3_MMT_MFU_CONTEXT_CALLBACKS_DEFAULT_JNI_DEBUG_ENABLED;
extern int _ATSC3_MMT_MFU_CONTEXT_CALLBACKS_DEFAULT_JNI_TRACE_ENABLED;

extern int _ATSC3_LOWASIS_PHY_RXDATA_ANDROID_INFO_ENABLED;
extern int _ATSC3_LOWASIS_PHY_RXDATA_ANDROID_DEBUG_ENABLED;
extern int _ATSC3_LOWASIS_PHY_RXDATA_ANDROID_TRACE_ENABLED;

extern int _ATSC3_STLTP_DEPACKETIZER_CONTEXT_INFO_ENABLED;
extern int _ATSC3_STLTP_DEPACKETIZER_CONTEXT_DEBUG_ENABLED;

extern int _ATSC3_SRTRXSTLTPVIRTUALPHY_INFO_ENABLED;
