...
int Atsc3NdkApplicationBridge::pinFromRxCaptureThread() {
    NDK_APPLICATION_BRIDGE_INFO("Atsc3NdkPHYBridge::Atsc3_Jni_Processing_Thread_Env: mJavaVM: %p", mJavaVM);
    Atsc3_Jni_Processing_Thread_Env = new Atsc3JniEnv(mJavaVM);
    return 0;
};

int Atsc3NdkApplicationBridge::pinFromRxProcessingThread() {
    NDK_APPLICATION_BRIDGE_INFO("Atsc3NdkPHYBridge::pinFromRxProcessingThread: mJavaVM: %p", mJavaVM);
    Atsc3_Jni_Processing_Thread_Env = new Atsc3JniEnv(mJavaVM);
    return 0;
}
...
int Atsc3NdkApplicationBridge::pinFromRxStatusThread() {
    NDK_APPLICATION_BRIDGE_INFO("Atsc3NdkPHYBridge::pinFromRxStatusThread: mJavaVM: %p", mJavaVM);
...
void Atsc3NdkApplicationBridge::atsc3_lls_sls_alc_on_object_close_flag_s_tsid_content_location_jni(uint32_t tsi, uint32_t toi, char *content_location) {
    ...
    NDK_APPLICATION_BRIDGE_INFO("atsc3_lls_sls_alc_on_object_close_flag_s_tsid_content_location_jni: tsi: %d, toi: %d, content_location: %s", tsi, toi, content_location);
