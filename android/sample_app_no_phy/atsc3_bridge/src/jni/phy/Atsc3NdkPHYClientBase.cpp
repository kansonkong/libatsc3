...
Java_org_ngbp_libatsc3_middleware_android_phy_Atsc3NdkPHYClientBase_download_1bootloader_1firmware(JNIEnv *env, jobject thiz, jint fd) {
    return INT_MIN;
}

extern "C" JNIEXPORT jint JNICALL
Java_org_ngbp_libatsc3_middleware_android_phy_Atsc3NdkPHYClientBase_open(JNIEnv *env, jobject thiz, jint fd) {
    return INT_MIN;
}
