...
public class MfuByteBufferHandler {
    ...
    public static void PushMfuByteBufferFragment(MfuByteBufferFragment mfuByteBufferFragment) {
        ...
        if(MmtPacketIdContext.video_packet_statistics.extracted_sample_duration_us != 0 || MmtPacketIdContext.audio_packet_statistics.extracted_sample_duration_us == 0) {
            if(MmtPacketIdContext.audio_packet_id == mfuByteBufferFragment.packet_id) {
                Log.d("PushMfuByteBufferFragment:INFO", String.format(" packet_id: %d, mpu_sequence_number: %d, setting audio_packet_statistics.extracted_sample_duration_us to follow video: %d *2",
                        mfuByteBufferFragment.packet_id, mfuByteBufferFragment.mpu_sequence_number, MmtPacketIdContext.video_packet_statistics.extracted_sample_duration_us * 2));
            }
