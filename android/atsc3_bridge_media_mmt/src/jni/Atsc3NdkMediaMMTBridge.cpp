...
int Atsc3NdkMediaMMTBridge::pinConsumerThreadAsNeeded() {
    _NDK_APPLICATION_BRIDGE_INFO("Atsc3NdkMediaMMTBridge::pinConsumerThreadAsNeeded: mJavaVM: %p", mJavaVM);
    bridgeConsumerJniEnv = new Atsc3JniEnv(mJavaVM);
    return 0;
}

int Atsc3NdkMediaMMTBridge::releasePinnedConsumerThreadAsNeeded() {
    _NDK_APPLICATION_BRIDGE_INFO("Atsc3NdkMediaMMTBridge::releasePinnedConsumerThreadAsNeeded: bridgeConsumerJniEnv is: %p:", bridgeConsumerJniEnv);
...
Java_org_ngbp_libatsc3_middleware_Atsc3NdkMediaMMTBridge_init(JNIEnv *env, jobject instance)
{
    ...
    _NDK_APPLICATION_BRIDGE_INFO("Java_org_ngbp_libatsc3_middleware_Atsc3NdkMediaMMTBridge_init:  env: %p", env);
    mediaMMTBridge->setJniClassReference("org/ngbp/libatsc3/middleware/Atsc3NdkMediaMMTBridge");
    mediaMMTBridge->mJavaVM = atsc3_bridge_ndk_static_loader_get_javaVM();

    if(mediaMMTBridge->mJavaVM == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: mediaMMTBridge->mJavaVM is NULL!");
        return -1;
    }
    ...
    if (jniClassReference == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: cannot find Atsc3NdkMediaMMTBridge java class reference!");
        return -2;
    }
    ...
    if (mediaMMTBridge->mOnInitHEVC_NAL_Extracted == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: cannot find 'atsc3_onInitHEVC_NAL_Packet' method id");
        return -1;
    }
    ...
    */
    ...
    if (mediaMMTBridge->atsc3_signallingContext_notify_video_packet_id_and_mpu_timestamp_descriptor_ID == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: cannot find 'atsc3_signallingContext_notify_video_packet_id_and_mpu_timestamp_descriptor_ID' method id");
        return -1;
    }
    ...
    if (mediaMMTBridge->atsc3_signallingContext_notify_audio_packet_id_and_mpu_timestamp_descriptor_ID == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: cannot find 'atsc3_signallingContext_notify_audio_packet_id_and_mpu_timestamp_descriptor_ID' method id");
        return -1;
    }
    ...
    if (mediaMMTBridge->atsc3_signallingContext_notify_stpp_packet_id_and_mpu_timestamp_descriptor_ID == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: cannot find 'atsc3_signallingContext_notify_stpp_packet_id_and_mpu_timestamp_descriptor_ID' method id");
        return -1;
    }
    ...
    if (mediaMMTBridge->atsc3_onExtractedSampleDurationID == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: cannot find 'atsc3_onExtractedSampleDurationID' method id");
        return -1;
    }
    ...
    if (mediaMMTBridge->atsc3_setVideoWidthHeightFromTrakID == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: cannot find 'atsc3_setVideoWidthHeightFromTrakID' method id");
        return -1;
    }
    ...
    if (mediaMMTBridge->atsc3_onMfuPacketID == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: cannot find 'atsc3_onMfuPacket' method id");
        return -1;
    }
    //java.nio.ByteBuffer, L: fully qualified class, J: long
    ...
    if (mediaMMTBridge->atsc3_onMfuPacketCorruptID == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("AppBridge_init - Atsc3NdkMediaMMTBridge_init: cannot find 'atsc3_onMfuPacketCorrupt' method id");
        return -1;
    }
    ...
    if (mediaMMTBridge->atsc3_onMfuPacketCorruptMmthSampleHeaderID == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: cannot find 'atsc3_onMfuPacketCorruptMmthSampleHeaderID' method id");
        return -1;
    }
    ...
    if (mediaMMTBridge->atsc3_onMfuSampleMissingID == NULL) {
        _NDK_APPLICATION_BRIDGE_ERROR("Atsc3NdkMediaMMTBridge_init: cannot find 'atsc3_onMfuSampleMissingID' method id");
        return -1;
    }

    atsc3_ndk_media_mmt_bridge_init(mediaMMTBridge);
    _NDK_APPLICATION_BRIDGE_INFO("Atsc3NdkMediaMMTBridge_init: done, with mediaMMTBridge: %p", mediaMMTBridge);
