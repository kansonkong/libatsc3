...
//oem_data_t* MxL_HYDRA_OEM_DataPtr[MXL_HYDRA_MAX_NUM_DEVICES];
...
MXL_STATUS_E MxLWare_HYDRA_API_CfgDrvInit(UINT8 devId, Endeavour* endeavour, UINT8 i2cbus, UINT8 i2cadd, MXL_HYDRA_DEVICE_E deviceType)
{
	...
	if (status == MXL_E_NOT_INITIALIZED)
	{
	    // update initilized flag
	    devHandlePtr->initialized = MXL_E_TRUE;
		devHandlePtr->deviceType = deviceType;
	    devHandlePtr->intrMask = 0;
		devHandlePtr->features.chanBond = MXL_E_FALSE;
	    devHandlePtr->tsMap = NULL;

	    // store oem data pointer
		devHandlePtr->endeavour_mxl541 = endeavour;
		devHandlePtr->endeavour_mxl541_i2cBus = i2cbus;
		devHandlePtr->endeavour_mxl541_i2cAdd = i2cadd;
		/*
		MxL_HYDRA_OEM_DataPtr[devId]->endeavour_mxl541 = endeavour;
		MxL_HYDRA_OEM_DataPtr[devId]->endeavour_mxl541_i2cBus = i2cbus;
		MxL_HYDRA_OEM_DataPtr[devId]->endeavour_mxl541_i2cAdd = i2cadd;
		*/
		...
		case MXL_HYDRA_DEVICE_581C :
			devHandlePtr->features.clkOutAvailable = MXL_E_TRUE;
		...
		case MXL_HYDRA_DEVICE_585 :
	        devHandlePtr->features.clkOutAvailable = MXL_E_FALSE;
		    devHandlePtr->features.demodsCnt = 8;
		...
		case MXL_HYDRA_DEVICE_568 :
			...
			devHandlePtr->features.chanBond = MXL_E_TRUE;
			devHandlePtr->tsMap = tsMap1_to_1;
			devHandlePtr->gpioMaxNum = MXL_HYDRA_DEV_5X1_GPIO_MAX;
			devHandlePtr->gpioInfoPtr = gpioPinInfo_5x1;
			devHandlePtr->skuFamily = MXL_HYDRA_SKU_56X;
		...
		devHandlePtr->dss2dvbEnacapMode[MXL_HYDRA_DEMOD_ID_0] = MXL_E_FALSE;
		devHandlePtr->dss2dvbEnacapMode[MXL_HYDRA_DEMOD_ID_1] = MXL_E_FALSE;
		devHandlePtr->dss2dvbEnacapMode[MXL_HYDRA_DEMOD_ID_2] = MXL_E_FALSE;
		devHandlePtr->dss2dvbEnacapMode[MXL_HYDRA_DEMOD_ID_3] = MXL_E_FALSE;
		devHandlePtr->dss2dvbEnacapMode[MXL_HYDRA_DEMOD_ID_4] = MXL_E_FALSE;
		devHandlePtr->dss2dvbEnacapMode[MXL_HYDRA_DEMOD_ID_5] = MXL_E_FALSE;
		devHandlePtr->dss2dvbEnacapMode[MXL_HYDRA_DEMOD_ID_6] = MXL_E_FALSE;
		devHandlePtr->dss2dvbEnacapMode[MXL_HYDRA_DEMOD_ID_7] = MXL_E_FALSE;
...
MXL_STATUS_E MxLWare_HYDRA_API_CfgDrvUnInit(UINT8 devId)
{
	...
	{
		// update initilized flag
		devHandlePtr->initialized = MXL_E_FALSE;

		devHandlePtr->intrMask = 0;

		// store oem data pointer
		devHandlePtr->endeavour_mxl541 = NULL;
	...
	else if (status == MXL_E_NOT_INITIALIZED)
	{
