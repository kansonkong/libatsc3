...
#define MXL_HYDRA_OEM_MAX_BLOCK_WRITE_LENGTH 250 /* maximum number bytes allowed in one I2C block write */
...
#define MXL_HYDRA_DEBUG(...)              
#define MXL_HYDRA_ERROR(...)              
#define MXL_HYDRA_PRINT(...)               
...
#define MXL_MODULE_DEBUG_OPTIONS 0
