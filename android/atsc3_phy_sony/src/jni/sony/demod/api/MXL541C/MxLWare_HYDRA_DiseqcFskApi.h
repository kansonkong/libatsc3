...
#define MXL_HYDRA_FSK_MSG_T_SIZE	(MXL_HYDRA_FSK_MESG_MAX_LENGTH+8)
...
#define	MXL58x_CFG_FSK_FREQ_T_SIZE	8
...
#define MXL58x_DSQ_OP_MODE_TXRX_T_SIZE	28
...
#define MXL_HYDRA_DISEQC_CFG_CONT_TONE_T_SIZE	8	
