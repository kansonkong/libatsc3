...
#define MXL_HYDRA_DEMOD_IQ_SRC_T_SIZE	8

typedef struct
{
	UINT32	demodId;
} MXL_HYDRA_DEMOD_ABORT_TUNE_T;
#define MXL_HYDRA_DEMOD_ABORT_TUNE_T_SIZE	4
...
#define MxL_HYDRA_TUNER_CMD_SIZE	2
...
#define MXL_HYDRA_DEMOD_SCRAMBLE_CODE_T_SIZE	20
...
#define MXL_HYDRA_SKU_COMMAND_T_SIZE	4
...
#define MXL_HYDRA_RF_WAKEUP_PARAM_T_SIZE	12
...
#define MXL_HYDRA_RF_WAKEUP_CFG_T_SIZE	(MXL_HYDRA_RF_WAKEUP_PARAM_T_SIZE+4)
...
#define MXL_HYDRA_DISEQC_TX_MSG_CMD_T_SIZE	(MXL_HYDRA_DISEQC_MAX_PKT_SIZE+12)
...
#define MXL_HYDRA_RSSI_MONITOR_INFO_T_SIZE	12
...
#define MXL_HYDRA_BROADCAST_WAKEUP_CFG_T_SIZE	(MXL_HYDRA_DEMOD_PARAM_T_SIZE+16)
