...
uint32_t sony_cxd6801_math_log2 (uint32_t x)
{
    uint8_t count = 0;
    uint8_t index = 0;
    uint32_t xval = x;
...
uint32_t sony_cxd6801_math_log10 (uint32_t x)
{
    /* log10(x) = log2 (x) / log2 (10) */
    /* Note uses: logN (x) = logM (x) / logM (N) */
    return ((100 * sony_cxd6801_math_log2 (x) + LOG2_10_100X / 2) / LOG2_10_100X);
}

uint32_t sony_cxd6801_math_log (uint32_t x)
{
    /* ln (x) = log2 (x) / log2(e) */
    return ((100 * sony_cxd6801_math_log2 (x) + LOG2_E_100X / 2) / LOG2_E_100X);
}
