...
#ifndef SONY_CXD6801_I2C_H
#define SONY_CXD6801_I2C_H

#include "sony_cxd6801_common.h"

#define SONY_CXD6801_I2C_START_EN   (0x01)  /**< Output START (S) */
#define SONY_CXD6801_I2C_STOP_EN    (0x02)  /**< Output STOP  (P) */
...
*/
typedef struct sony_cxd6801_i2c_t {
    /**
    ...
    */
	sony_cxd6801_result_t(*Read)(struct sony_cxd6801_i2c_t* pI2c, uint8_t deviceAddress, uint8_t* pData, uint32_t size, uint8_t mode);
    /**
     ...
     @return SONY_RESULT_OK if successful.
    */
	sony_cxd6801_result_t(*Write)(struct sony_cxd6801_i2c_t* pI2c, uint8_t deviceAddress, const uint8_t *pData, uint32_t size, uint8_t mode);
    /**
     ...
     @return SONY_RESULT_OK if successful.
    */
	sony_cxd6801_result_t(*ReadRegister)(struct sony_cxd6801_i2c_t* pI2c, uint8_t deviceAddress, uint8_t subAddress, uint8_t* pData, uint32_t size);
    /**
     ...
     @return SONY_RESULT_OK if successful.
    */
	sony_cxd6801_result_t(*WriteRegister)(struct sony_cxd6801_i2c_t* pI2c, uint8_t deviceAddress, uint8_t subAddress, const uint8_t *pData, uint32_t size);
    /**
     ...
     @return SONY_RESULT_OK if successful.
    */
	sony_cxd6801_result_t(*WriteOneRegister)(struct sony_cxd6801_i2c_t* pI2c, uint8_t deviceAddress, uint8_t subAddress, uint8_t data);
