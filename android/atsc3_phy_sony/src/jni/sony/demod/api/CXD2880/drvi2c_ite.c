...
sony_result_t drvi2c_ite_Read(sony_i2c_t* pI2c, uint8_t deviceAddress, uint8_t* pData, uint32_t size, uint8_t mode);
sony_result_t drvi2c_ite_Write(sony_i2c_t* pI2c, uint8_t deviceAddress, const uint8_t* pData, uint32_t size, uint8_t mode);
...
{	
    pI2c->Read = drvi2c_ite_Read;
    pI2c->Write = drvi2c_ite_Write;
